    ...
    if (widget.role == UserRole.affiliater) {
      return AffiliaterDrawer(
        ...
        actions: AffiliaterDrawerActions(
          ...
          onAffiliate: () => Navigator.of(context).push(MaterialPageRoute(
            builder: (_) => const PlaceholderPage(
              title: 'Affiliate',
              icon: Icons.link_rounded,
              description: 'Your unique affiliate link generator and sharing tools.',
            ),
          )),
          ...
          onSupport: () => Navigator.of(context).push(MaterialPageRoute(
            builder: (_) => const PlaceholderPage(
              ...
              description: 'Get help from the Onsite team or browse FAQs.',
            ),
          )),
          onLogout: _logout,
        ),
    ...
    if (widget.role == UserRole.investor) {
      return InvestorDrawer(
        ...
        actions: InvestorDrawerActions(
          ...
          onInvestmentAssets: () => Navigator.of(context).push(MaterialPageRoute(
            builder: (_) => const PlaceholderPage(
              title: 'Investment Assets',
              icon: Icons.apartment_outlined,
              description: 'Live status on rental income, appreciation, and property health.',
            ),
          )),
          ...
          onProfitsPayouts: () => Navigator.of(context).push(MaterialPageRoute(
            builder: (_) => const PlaceholderPage(
              title: 'Profits & Payouts',
              icon: Icons.payments_outlined,
              description: 'Records of returns, distributions, and capital payouts.',
            ),
          )),
          onWallet: () => Navigator.of(context).push(MaterialPageRoute(
            builder: (_) => const PlaceholderPage(
              ...
              description: 'Your balance, deposits, and withdrawal methods.',
            ),
          )),
          ...
          onEventsTournaments: () => Navigator.of(context).push(MaterialPageRoute(
            builder: (_) => const PlaceholderPage(
              title: 'Events & Tournaments',
              icon: Icons.emoji_events_outlined,
              description: 'Upcoming investor events, webinars, and tournaments.',
            ),
          )),
          onNewsAnnouncements: () => Navigator.of(context).push(MaterialPageRoute(
            builder: (_) => const PlaceholderPage(
              ...
              icon: Icons.campaign_outlined,
              description: 'The latest updates from the Onsite team.',
            ),
          )),
          onDocuments: () => Navigator.of(context).push(MaterialPageRoute(
            builder: (_) => const PlaceholderPage(
              title: 'Documents',
              icon: Icons.folder_shared_outlined,
              description: 'Contracts, tax forms, and ownership certificates.',
            ),
          )),
          onSupport: () => Navigator.of(context).push(MaterialPageRoute(
            builder: (_) => const PlaceholderPage(
