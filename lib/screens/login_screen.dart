...
class _DemoRouterPanel extends StatelessWidget {
  ...
  static const _accounts = [
    ('visitor@ebn.demo', 'Visitor', Icons.explore_rounded),
    ('affiliater@ebn.demo', 'Affiliater', Icons.share_rounded),
    ('agent@ebn.demo', 'Agent / Broker', Icons.badge_rounded),
    ('investor@ebn.demo', 'Investor', Icons.trending_up_rounded),
  ];
