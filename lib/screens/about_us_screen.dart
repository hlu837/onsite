  ...
  Widget build(BuildContext context) {
    return MarketingPageShell(
      ...
      child: Column(
        ...
        children: [
          const Text('About Onsite',
            style: TextStyle(fontSize: 32, fontWeight: FontWeight.w600, color: LandingColors.foreground)),
          const SizedBox(height: 16),
          const Text(
            'Onsite is a real-time, crowd-sourced verification network. Instead of trusting listing '
          ...
          const Text(
            'Onsite is live in Addis Ababa today, with more cities planned as our agent network '
            'grows.',
            style: TextStyle(fontSize: 15, color: LandingColors.muted, height: 1.6),
          ),
        ],
