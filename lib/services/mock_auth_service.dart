...
final Map<String, UserRole> _accountDirectory = {
  'visitor@ebn.demo': UserRole.user,
  'affiliater@ebn.demo': UserRole.affiliater,
  'agent@ebn.demo': UserRole.agent,
  'investor@ebn.demo': UserRole.investor,
  'admin@ebn.demo': UserRole.admin,
};
