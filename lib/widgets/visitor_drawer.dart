...
/// Explore Feed · Saved Listings · Search & Map Directory · About/FAQ
            ...
            Expanded(
              child: ListView(
                ...
                children: [
                  ...
                  _DrawerItem(icon: Icons.map_outlined, label: 'Search & Map Directory', onTap: () => _tap(context, actions.onSearchMap)),
